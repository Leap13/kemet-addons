...
if (document.getElementById("animated-icon") != null && document.querySelector(".kmt-navbar-collapse") != null) {
    document.getElementById("animated-icon").addEventListener("click", function () {
        ...
        DOMAnimations.slideToggle(document.querySelector(".kmt-navbar-collapse"));
    });
}
