(function ($) {
    ...
    kemet_css('kemet-settings[logo-icon-separator-color]', 'background-color', '.header-main-layout-8 .inline-logo-menu .logo-icon-separator');
    ...
    wp.customize('kemet-settings[header-separator-height]', function (setting) {
        setting.bind(function (height) {
            ...
            var dynamicStyle = '.header-main-layout-8 .inline-logo-menu .logo-icon-separator { height: ' + (parseInt(height)) + 'px } ';
