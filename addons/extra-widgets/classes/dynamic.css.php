...
function kemet_ext_widgets_dynamic_css( $dynamic_css ) {
            ...
            $css_content = array(     
                '.kmt-widget-style2 .widget-head ,.kmt-widget-style3 .widget-title ,.kmt-widget-style4 .widget-content,.kmt-widget-style5 .widget-content ,.kmt-widget-style7 .widget-head,.kmt-widget-style8 div.title .widget-title ,.kmt-widget-style8 div.title .widget-title:before' => array(
					...
					'border-bottom-width' => kemet_get_css_value( $widget_style_color , 'px' ),
					'border-bottom-color' => esc_attr( $widget_style_color ),
				),
				'.kmt-widget-style2 .widget-title ,.kmt-widget-style5 .widget-head ,.kmt-widget-style6 .widget-head ,.kmt-widget-style10 div.title .widget-title:after' => array(
					'background-color' => esc_attr( $widget_style_color ),
				),
				'.kmt-widget-style2 .widget-title ,.kmt-widget-style5 .widget-head ,.kmt-widget-style6 .widget-head,.kmt-widget-style9 .widget ,.kmt-widget-style10 .widget-title:after' => array(
					'background-color' => esc_attr( $widget_style_color ),
				),
				'.kmt-widget-style1 .widget-title,.kmt-widget-style3 .widget-title ,.kmt-widget-style4 .widget-title ,.kmt-widget-style7 .widget-title ,.kmt-widget-style8 .widget-title' => array(
