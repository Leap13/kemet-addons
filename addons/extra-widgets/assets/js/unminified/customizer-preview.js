(function ($) {
    wp.customize('kemet-settings[widget-style-color]', function (setting) {
        setting.bind(function (color) {
            ...
            kemet_add_dynamic_css('widget-style-color', dynamicStyle);

        });
    });
    wp.customize('kemet-settings[footer-widget-style-color]', function (setting) {
        setting.bind(function (color) {
            ...
            kemet_add_dynamic_css('footer-widget-style-color', dynamicStyle);
