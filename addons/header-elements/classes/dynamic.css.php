...
function kemet_header_elements_dynamic_css( $dynamic_css ) {
	$elementor_template_spacing = kemet_get_option( 'elementor-template-margin' );
	$reusable_block_spacing     = kemet_get_option( 'reusable-block-margin' );

	$css_output = array(
		'.kmt-header-elementor-template' => array(
		...
		'.kmt-header-reusable-block'     => array(
