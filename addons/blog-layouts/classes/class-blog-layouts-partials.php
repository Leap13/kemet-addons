...
if (! class_exists('Kemet_Blog_Layouts_Partials')) {
    ...
    class Kemet_Blog_Layouts_Partials {
		...
		public function __construct() {
            ...
            add_action( 'wp_enqueue_scripts', array( $this, 'add_lightbox_scripts'), 1 );
        }
        ...
        function add_lightbox_scripts() {
            // Light Box.
			wp_enqueue_style( 'prettyPhoto-css', KEMET_BLOG_LAYOUTS_URL . 'assets/lightbox/css/lightbox.css' , null, KEMET_ADDONS_VERSION );
			wp_enqueue_script( 'prettyPhoto-js', KEMET_BLOG_LAYOUTS_URL . 'assets/lightbox/js/lightbox.js', array(), KEMET_ADDONS_VERSION, true );
