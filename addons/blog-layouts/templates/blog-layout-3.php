...
<div <?php kemet_blog_layout_class('blog-post-layout-3'); ?>>
    ...
    <header class="entry-header">
        <?php $overlay_image = $enable_overlay ? kemet_addons_get_thumbnail_with_overlay( '<div class="kmt-blog-featured-section post-thumb">', '</div>' ) : kemet_get_post_thumbnail( '<div class="kmt-blog-featured-section post-thumb">', '</div>' ); ?>
    </header><!-- .entry-header -->
