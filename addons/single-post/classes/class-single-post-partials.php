...
if (! class_exists('Kemet_Single_Post_Partials')) {
    ...
    class Kemet_Single_Post_Partials
    {
		...
		public function __construct() {
            ...
            add_action( 'kemet_entry_content_single', array( $this, 'kemet_single_post_template'));
            //add_action( 'kemet_get_js_files', array( $this, 'add_scripts' ) );
        }

        public function kemet_single_post_template() {
        ...
        //     $prev_next_links = kemet_get_option('next-prev-links');
