    ...
    cssmin: {
      css: {
        files: [
          ...
          {
            src: "addons/custom-layout/assets/css/unminified/select2.css",
            dest: "addons/custom-layout/assets/css/minified/select2.min.css",
          },
        ],
      },
    },
    uglify: {
      dist: {
        files: {
          ...
          "addons/custom-layout/assets/js/minified/select2.min.js":
            "addons/custom-layout/assets/js/unminified/select2.js",
          "inc/k-framework/assets/js/kfw-plugins-field.min.js":
            "inc/k-framework/assets/js/kfw-plugins-field.js",
