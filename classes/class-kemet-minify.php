...
if ( ! class_exists( 'Kemet_Minify' ) ) {
	...
	class Kemet_Minify {
		...
		public function __construct() {
            ...
            //wp_add_inline_style( 'kemet-addon-css', apply_filters( 'kemet_addons_dynamic_css', '' ) );
...
//        }
		...
		public function merge_all_scripts() 
		{
           ...
           // chmod($merged_css_file_location, "0664");
            ...
            //wp_add_inline_style( 'merged-style', apply_filters( 'kemet_dynamic_css', '' ) );
			//wp_add_inline_style( 'kemet_addons_dynamic_css', apply_filters( 'kemet_addon_dynamic_css', 20 ) );
