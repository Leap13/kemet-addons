            ...
            <table class="widefat" cellspacing="0">
                ...
                <tbody>
                    ...
                    if ($memory_limit < 67108864) {
                        echo '<mark>' . sprintf(__('%1$s - We recommend setting wp memory at least 64MB.', 'kemet-addons'), size_format($memory_limit));
                    } else {
            ...
            <table class="widefat" cellspacing="0">
                ...
                <tbody>
                    ...
                    if ($time_limit < 60 && $time_limit != 0) {
                        echo '<mark>' . sprintf(__('%s - We recommend setting max execution time at least 60.', 'kemet-addons'), $time_limit);
                    } else {
                        echo $time_limit;
                    } ?></td>
                        </tr>
