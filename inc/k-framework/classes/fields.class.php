...
if ( ! class_exists( 'KFW_Fields' ) ) {
  abstract class KFW_Fields extends KFW_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="kfw-before-text">'. wp_kses_post( $this->field['before'] ) .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="kfw-after-text">'. wp_kses_post( $this->field['after'] ) .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="kfw-desc-text">'. wp_kses_post( $this->field['desc'] ) .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="kfw-help"><span class="kfw-help-text">'. wp_kses_post( $this->field['help'] ) .'</span><i class=" fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="kfw-error-text">'. wp_kses_post( $this->field['_error'] ) .'</div>' : '';
