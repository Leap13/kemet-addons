  ...
  class KFW_Field_repeater extends KFW_Fields {
    ...
    public function render() {
      ...
      if( $this->parent && preg_match( '/'. preg_quote( '['. $this->field['id'] .']' ) .'/', $this->parent ) ) {
        ...
        echo '<i class="kfw-repeater-sort fa fa-arrows"></i>';
        ...
        echo '<div class="kfw-repeater-wrapper kfw-data-wrapper" data-unique-id="'. $this->unique .'" data-field-id="['. $this->field['id'] .']" data-max="'. $args['max'] .'" data-min="'. $args['min'] .'">';
        ...
        echo '<div class="kfw-repeater-alert kfw-repeater-max">'. esc_html__( 'You can not add more than', 'kfw' ) .' '. $args['max'] .'</div>';
        echo '<div class="kfw-repeater-alert kfw-repeater-min">'. esc_html__( 'You can not remove less than', 'kfw' ) .' '. $args['min'] .'</div>';

        echo '<a href="#" class="button button-primary kfw-repeater-add">'. $args['button_title'] .'</a>';
